        ...
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="name" class="control-label">Node Identifier</label>
                        <div>
                            <div class="input-group">
                                <input type="text" readonly class="form-control" value="{{ $node->node_identifier ?? 'Not set' }}" />
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-default copy-identifier-btn"
                        ...
                        <p class="text-muted small">This is the secure unique identifier for this node. Use it to install Wings on the target machine.</p>
                    </div>
