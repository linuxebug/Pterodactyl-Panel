...
Route::group(['prefix' => 'nodes'], function () {
    ...
    Route::get('/view/{node:id}/status', Admin\Nodes\NodeStatusController::class)->name('admin.nodes.view.status');
    ...
    Route::post('/view/{node:id}/test-connection', Admin\Nodes\NodeTestConnectionController::class)->name('admin.nodes.view.test-connection');
...
|--------------------------------------------------------------------------
|
| Endpoint: /admin/installer
|
*/
Route::group(['prefix' => 'installer', 'middleware' => ['admin']], function () {
    Route::get('/', [Admin\InstallerController::class, 'index'])->name('admin.installer');
    Route::get('/complete', [Admin\InstallerController::class, 'complete'])->name('admin.installer.complete');
    Route::get('/connection-options', [Admin\InstallerController::class, 'connectionOptions'])->name('admin.installer.connection');
    Route::get('/admin-setup', [Admin\InstallerController::class, 'adminSetupForm'])->name('admin.installer.admin-setup');
    Route::get('/check-port', [Admin\InstallerController::class, 'checkPort'])->name('admin.installer.check-port');

    Route::post('/install', [Admin\InstallerController::class, 'install'])->name('admin.installer.install');
    Route::post('/create-admin', [Admin\InstallerController::class, 'createAdmin'])->name('admin.installer.create-admin');
});

/*
|--------------------------------------------------------------------------
| Hosting Settings Routes
|--------------------------------------------------------------------------
|
| Endpoint: /admin/hosting
|
*/
Route::group(['prefix' => 'hosting', 'middleware' => ['admin']], function () {
    Route::get('/settings', [Admin\HostingSettingsController::class, 'index'])->name('admin.hosting.settings');
    Route::post('/settings/logo', [Admin\HostingSettingsController::class, 'uploadLogo'])->name('admin.hosting.settings.logo');
    Route::delete('/settings/logo', [Admin\HostingSettingsController::class, 'removeLogo'])->name('admin.hosting.settings.logo.remove');
});
