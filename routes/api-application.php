...
Route::group(['prefix' => '/nodes'], function () {
    ...
    Route::get('/{node:id}/status', Application\Nodes\NodeStatusApiController::class);
    Route::post('/{node:id}/test-connection', Application\Nodes\NodeTestConnectionApiController::class);
});
